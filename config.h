...
static const char *fonts[]          = { "SourceCodePro-Regular:size=10", "NotoColorEmoji:pixelsize=10:antialias=true:autohint=true" };
...
static const char *top[] = { "st", "top", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_w,      spawn,          {.v = qute } },
	...
	{ MODKEY,                       XK_c,      spawn,          {.v = top } },
	{ MODKEY,                       XK_v,      spawn,          {.v = nmtui } },
	...
	{ MODKEY,                       XK_F1,     spawn,          SHCMD("slp.sh")  },
	{ MODKEY,                       XK_F2,     spawn,          SHCMD("slock")  },
	{ MODKEY,                       XK_F3,     spawn,          SHCMD("")  },
	{ MODKEY,                       XK_F4,     spawn,          SHCMD("sdn.sh")  },
